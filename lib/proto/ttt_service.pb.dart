...
class Game extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Game', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protos'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..hasRequiredFields = false
  ;
...
class HandShake extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HandShake', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protos'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;

  HandShake._() : super();
  factory HandShake() => create();
...
class Response extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Response_Data> _Response_DataByTag = {
    1 : Response_Data.gameId,
    2 : Response_Data.handshake,
    0 : Response_Data.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Response', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protos'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<Game>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gameId', subBuilder: Game.create)
    ..aOM<HandShake>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'handshake', subBuilder: HandShake.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  Game get gameId => $_getN(0);
  @$pb.TagNumber(1)
  set gameId(Game v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasGameId() => $_has(0);
  @$pb.TagNumber(1)
  void clearGameId() => clearField(1);
  @$pb.TagNumber(1)
  Game ensureGameId() => $_ensure(0);
...
class Status extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Status', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protos'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stat', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.int get stat => $_getIZ(0);
  @$pb.TagNumber(1)
  set stat($core.int v) { $_setSignedInt32(0, v); }
  @$pb.TagNumber(1)
...
class FinalGame extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FinalGame', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protos'), createEmptyInstance: create)
  ...
  factory FinalGame.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FinalGame.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  FinalGame clone() => FinalGame()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FinalGame copyWith(void Function(FinalGame) updates) => super.copyWith((message) => updates(message as FinalGame)) as FinalGame; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static FinalGame create() => FinalGame._();
  FinalGame createEmptyInstance() => create();
  static $pb.PbList<FinalGame> createRepeated() => $pb.PbList<FinalGame>();
  @$core.pragma('dart2js:noInline')
  static FinalGame getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FinalGame>(create);
  static FinalGame? _defaultInstance;
